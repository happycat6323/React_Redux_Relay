!function () {
    ...
    var Faye = {
        ...
        asyncEach: function (e, t, n, i) {
            var s = e.length, r = -1, o = 0, a = !1, c = function () {
                return o -= 1, r += 1, r === s ? n && n.call(i) : (t(e[r], h), void 0)
            }, u = function () {
                if (!a) {
                    for (a = !0; o > 0;)c();
                    a = !1
    ...
    "undefined" != typeof module ? module.exports = Faye : "undefined" != typeof window && (window.Faye = Faye), Faye.Class = function (e, t) {
        ...
        LOG_LEVELS: {fatal: 4, error: 3, warn: 2, info: 1, debug: 0}, writeLog: function (e, t) {
            if (Faye.logger) {
                var e = Array.prototype.slice.apply(e), n = "[Faye", i = this.className, s = e.shift().replace(/\?/g, function () {
                    try {
        ...
        addExtension: function (e) {
            ...
            var r = this._extensions.slice(), o = function (t) {
                ...
                var c = a[e];
                return c ? (c.length >= 3 ? a[e](t, n, o) : a[e](t, o), void 0) : o(t)
            };
            o(t)
        }
        ...
        get: function (e, t, n, i, s) {
            ...
            Faye.asyncEach(this._transports, function (o, a) {
                var c = o[0], u = o[1], h = e.endpoints[c] || r;
                return Faye.indexOf(n, c) >= 0 ? a() : Faye.indexOf(t, c) < 0 ? (u.isUsable(e, h, function () {
                }), a()) : (u.isUsable(e, h, function (t) {
                    if (!t)return a();
        ...
        isUsable: function (e, t, n, i) {
            var s = e._clientId;
            return s ? (Faye.Transport.XHR.isUsable(e, t, function (s) {
                return s ? (this.create(e, t).isUsable(n, i), void 0) : n.call(i, !1)
            }, this), void 0) : n.call(i, !1)
        }, create: function (e, t) {
        ...
        encode: function (e) {
            ...
            Faye.Event.on(Faye.ENV, "beforeunload", o), n.onreadystatechange = function () {
                if (n && 4 === n.readyState) {
                    ...
                    if (Faye.Event.detach(Faye.ENV, "beforeunload", o), n.onreadystatechange = function () {
        ...
        encode: function (e) {
            ...
            var t, n = Faye.ENV.XDomainRequest ? XDomainRequest : XMLHttpRequest, i = new n, s = this._client.headers, r = this;
            ...
            var o = function () {
                return i ? (i.onload = i.onerror = i.ontimeout = i.onprogress = null, i = null, void 0) : !1
            };
            i.onload = function () {
                var t = null;
                try {
        ...
        encode: function (e) {
            ...
            var t = Faye.map(e, function (e) {
                return e.message
            }), n = document.getElementsByTagName("head")[0], i = document.createElement("script"), s = Faye.Transport.JSONP.getCallbackName(), r = Faye.copyObject(this.endpoint), o = this;
